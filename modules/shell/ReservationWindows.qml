...
Item {
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "shell:reservation:top"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:reservation:bottom"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:reservation:left"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:reservation:right"
