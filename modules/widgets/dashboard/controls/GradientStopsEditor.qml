...
Item {
    ...
    readonly property var defaultGradient: {
        ...
        const defaults = themeDefaults[variantKey];
        return defaults && defaults.gradient
            ? JSON.parse(JSON.stringify(defaults.gradient))
            : [["surface", 0.0]];
    }
        ...
        RowLayout {
            ...
            StyledRect {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        root.updateStops(JSON.parse(JSON.stringify(root.defaultGradient)));
