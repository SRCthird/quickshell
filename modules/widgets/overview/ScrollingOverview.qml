...
Item {
    ...
    readonly property var monitor: currentScreen ? HyprctlService.monitorFor(currentScreen) : HyprctlService.focusedMonitor
    ...
    readonly property string focusedWindowAddress: HyprctlService.focusedClient?.address ?? ""
