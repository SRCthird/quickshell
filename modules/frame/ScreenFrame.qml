...
Item {
    ...
    readonly property bool hasFullscreenWindow: {
        const monitor = HyprctlService.monitorFor(targetScreen);
        if (!monitor)
            return false;
        ...
        if (toplevel && toplevel.fullscreen && HyprctlService.focusedMonitor.id === monId) {
            return true;
        }
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "shell:screenFrame:top"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:screenFrame:bottom"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:screenFrame:left"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:screenFrame:right"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: WlrLayer.Top
        WlrLayershell.keyboardFocus: WlrKeyboardFocus.None
        WlrLayershell.namespace: "shell:screenFrame:overlay"
