...
Singleton {
    ...
    // Battery low warning
    property bool batteryLowVisible: false
    ...
    // Compositor config properties (HyprctlService)
    ...
    function toggleAssistant() {
        if (assistantVisible) {
            ...
            if (HyprctlService.focusedMonitor && HyprctlService.focusedMonitor.name) {
                assistantScreenName = HyprctlService.focusedMonitor.name;
